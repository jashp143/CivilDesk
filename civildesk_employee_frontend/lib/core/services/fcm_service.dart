...
class FCMService {
  ...
  void _handleForegroundMessage(RemoteMessage message) {
    ...
    // Refresh notification list if callback is set
  ...
  // Set callback to refresh notifications when new messages arrive
  ...
  void _refreshNotificationList() {
    if (_onNotificationReceived != null) {
      // Use a small delay to ensure the backend has saved the notification
