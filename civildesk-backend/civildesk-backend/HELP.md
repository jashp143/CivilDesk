...
* The original package name 'com.civiltech.civildesk-backend' is invalid and this project uses 'com.civiltech.civildesk_backend' instead.
...
```
$ docker run --rm -p 8080:8080 civildesk-backend:0.0.1-SNAPSHOT
```
