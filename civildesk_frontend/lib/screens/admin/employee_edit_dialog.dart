...
class _EmployeeEditDialogState extends State<EmployeeEditDialog>
  ...
  late final TextEditingController _esicNumberController;
  ...
  late final TextEditingController _conveyanceController;
  late final TextEditingController _uniformAndSafetyController;
  late final TextEditingController _bonusController;
  late final TextEditingController _foodAllowanceController;
  late final TextEditingController _otherAllowanceController;
  late final TextEditingController _overtimeRateController;
  late final TextEditingController _epfEmployeeController;
  late final TextEditingController _epfEmployerController;

  // Step 6: Deduction Structure Information
  late final TextEditingController _esicPercentController;
  late final TextEditingController _professionalTaxController;
  ...
  void initState() {
    ...
    _bloodGroupController = TextEditingController(text: emp.bloodGroup ?? '');
    
    _emailController = TextEditingController(text: emp.email);
    _phoneController = TextEditingController(text: emp.phoneNumber);
    _alternatePhoneController = TextEditingController(text: emp.alternatePhoneNumber ?? '');
    _addressLine1Controller = TextEditingController(text: emp.addressLine1 ?? '');
    _addressLine2Controller = TextEditingController(text: emp.addressLine2 ?? '');
    _cityController = TextEditingController(text: emp.city ?? '');
    _stateController = TextEditingController(text: emp.state ?? '');
    _pincodeController = TextEditingController(text: emp.pincode ?? '');
    
    _aadharController = TextEditingController(text: emp.aadharNumber);
    _panController = TextEditingController(text: emp.panNumber);
    _uanController = TextEditingController(text: emp.uanNumber ?? '');
    _esicNumberController = TextEditingController(text: emp.esicNumber ?? '');
    ...
    _conveyanceController = TextEditingController(text: emp.conveyance?.toString() ?? '');
    _uniformAndSafetyController = TextEditingController(text: emp.uniformAndSafety?.toString() ?? '');
    _bonusController = TextEditingController(text: emp.bonus?.toString() ?? '');
    _foodAllowanceController = TextEditingController(text: emp.foodAllowance?.toString() ?? '');
    _otherAllowanceController = TextEditingController(text: emp.otherAllowance?.toString() ?? '');
    _overtimeRateController = TextEditingController(text: emp.overtimeRate?.toString() ?? '');
    _epfEmployeeController = TextEditingController(text: emp.epfEmployee?.toString() ?? '');
    _epfEmployerController = TextEditingController(text: emp.epfEmployer?.toString() ?? '');
    _esicPercentController = TextEditingController(text: emp.esic?.toString() ?? '');
    _professionalTaxController = TextEditingController(text: emp.professionalTax?.toString() ?? '');
    
    _bankNameController = TextEditingController(text: emp.bankName ?? '');
    _accountNumberController = TextEditingController(text: emp.bankAccountNumber ?? '');
    _ifscController = TextEditingController(text: emp.ifscCode ?? '');
    _bankBranchController = TextEditingController(text: emp.bankBranch ?? '');
    ...
    _emergencyRelationController = TextEditingController(text: emp.emergencyContactRelation ?? '');
  }
  ...
  Future<void> _submitForm() async {
    ...
    final employee = Employee(
      ...
      country: widget.employee.country ?? 'India',
      ...
      employmentStatus: widget.employee.employmentStatus,
      isActive: widget.employee.isActive,
    );

    final provider = context.read<EmployeeProvider>();
    final success = await provider.updateEmployee(widget.employee.id!, employee);
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: _nextTab,
                    child: Text(_tabController.index == _tabController.length - 1 ? 'Update' : 'Next'),
                  ),
                ],
              ),
            ),
