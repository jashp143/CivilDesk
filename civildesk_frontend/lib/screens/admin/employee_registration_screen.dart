...
class _EmployeeRegistrationScreenState extends State<EmployeeRegistrationScreen> {
  ...
  // Step 9: Face Registration (placeholder - will be implemented separately)
  
  // Step 10: Employee App Credentials (placeholder - will be shown after registration)
  ...
  Widget build(BuildContext context) {
    return AdminLayout(
      ...
      title: Text('Employee Registration (${_currentStep + 1}/$_totalSteps)'),
      child: Column(
        children: [
          ...
          Expanded(
            child: PageView(
              ...
              children: [
                ...
                _buildStep3Identification(),
                _buildStep4WorkInfo(),
                _buildStep5SalaryInfo(),
                _buildStep6DeductionInfo(),
                _buildStep7BankInfo(),
                _buildStep8EmergencyContact(),
                _buildStep9FaceRegistration(),
                _buildStep10Credentials(),
              ],
            ),
          ),
          Padding(
  ...
  Widget _buildStep3Identification() {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16.0),
      child: Form(
        key: _formKeys[2],
  ...
  Widget _buildStep6DeductionInfo() {
    final hasEsic = _esicNumberController.text.trim().isNotEmpty;
  ...
  Widget _buildStep8EmergencyContact() {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16.0),
      child: Form(
        key: _formKeys[7],
  ...
  Widget _buildStep9FaceRegistration() {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16.0),
      child: Form(
        key: _formKeys[8],
  ...
  Widget _buildStep10Credentials() {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16.0),
      child: Form(
        key: _formKeys[9],
